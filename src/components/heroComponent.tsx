...
export const AnimatedMarqueeHero: React.FC<AnimatedMarqueeHeroProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full h-1/3 md:h-2/5 [mask-image:linear-gradient(to_bottom,transparent,black_20%,black_80%,transparent)] bg-gradient-to-b from-purple-50 via-purple-200 to-purple-300 p-3">
        <motion.div
